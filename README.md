# WhatsApp Baileys Killua

<p align="center">
  <img src="https://i.ibb.co/0ygGcrkP/jawadmd.jpg" alt="Thumbnail" />
</p>
...
await sock.sendMessage(target, { 
    albumMessage: [
        { image: cihuy, caption: "#Killuatech" },
        { image: { url: "URL IMAGE" }, caption: "#Killuatech" }
    ] 
}, { quoted: m });
```
...
await sock.sendMessage(target, { 
    pollResultMessage: { 
        ...
        pollVotes: [
            {
                optionName: "#Kolluatech",
                optionVoteCount: "112233"
            },
            {
                optionName: "#Killuatech",
                optionVoteCount: "1"
            }
        ] 
    } 
...
await sock.sendMessage(target, {
    interactiveMessage: {
        header: "#Killuatech",
        title: "#Killuatech",
        footer: "telegram: @cabrino4 ",
        buttons: [
            {
                name: "cta_copy",
                buttonParamsJson: JSON.stringify({
                    display_text: "#Killuatech",
                    id: "123456789",              
                    copy_code: "ABC123XYZ"
                })
            }
    ...
    interactiveMessage: {      
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                limited_time_offer: {            
                    text: "idk hummmm?",            
                    url: "https://t.me/cabrino4",            
                    copy_code: "#Killuatech",            
                    expiration_time: Date.now() * 999          
                },          
                bottom_sheet: {            
                    in_thread_buttons_limit: 2,            
                    divider_indices: [1, 2, 3, 4, 5, 999],            
                    list_title: "#Killuatech",            
                    button_title: "#Killuatech"          
                },          
                tap_target_configuration: {            
                    title: " X ",            
                    description: "bomboclard",            
                    canonical_url: "https://t.me/cabrino4",            
...
await sock.sendMessage(target, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/killuatech",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/Killuatech",
                    merchant_url: "https://t.me/Killuatech"
                })
            }
        ]
    }
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    display_text: "Telegram",
                    url: "https://t.me/cabrinkilua",
                    merchant_url: "https://t.me/cabrinokillua"
                })
            }
        ]
    }
...
- **Telegram**: [Telegram Contact](https://t.me/cabrino4)
- **Channel Tele**: [Channel Tele](https://t.me/cabrinokillua) 
...
<table>
  <tr>
    <td align="center">
      <a href="https://github.com/cabrin21">
        <img src="https://github.com/cabrin21-beep.png" width="80px;" style="border-radius:50%;" alt="Developer"/>
        <br />
        <sub><b>killua</b></sub>
      </a>
    </td>
